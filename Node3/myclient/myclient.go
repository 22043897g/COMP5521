...
func StartClient() {
	GetBlocks()
	//DoubleSpending("D", "C", "B", 150, 150)
	//BroadCastNewTransaction("D", "A", 20)
	//BroadCastNewTransaction("D", "C", 100)
	//BroadCastNewTransaction("D", "A", 100)
	//BroadCastNewTransaction("D", "B", 100)
